...
public class WeekStatisticFragment extends Fragment {
    ...
    public void createPieChartTime(View root) {
        ...
        HashMap<String, Integer> hashMap = databaseHelper.getCountTicketDataWeek(1, Integer.parseInt(String.valueOf(autoCompleteTextView.getText())));
        // Pie Time (Day)
        ...
        HashMap<String, Integer> hashMap1 = databaseHelper.getCountTicketDataWeekCancelled(1, Integer.parseInt(String.valueOf(autoCompleteTextView.getText())));
        ...
        HashMap<String, Integer> hashMap2 = databaseHelper.getCountTicketSeatNumberWeek(1, Integer.parseInt(String.valueOf(autoCompleteTextView.getText())));
